...
const BoletinStatus = () => {
    ...
    const fetchEstadoBoletines = async () => {
      try {
        ...
        const estadoBoletines = boletines.map(boletin => {
          console.log('Datos del boletín desde Supabase:', boletin);
          ...
          return {
            ...
            estado: boletin.estado || 'En Revision',
            comentarios: boletin.comentarios
          };
        });
        
        console.log('Estado boletines procesados:', estadoBoletines);
        setEstadoBoletines(estadoBoletines);
        setLoading(false);
      } catch (error) {
  ...
  return (
    <StatusContainer>
      <Container>
        <Title>Boletines del Proyecto</Title>
        <Subtitle>Lista de documentos y boletines creados</Subtitle>
        ...
        {loading ? (
          ...
          <EmptyMessage>
            <EmptyTitle>No hay boletines creados aún</EmptyTitle>
            <EmptySubtitle>Los boletines aparecerán aquí cuando sean creados</EmptySubtitle>
          </EmptyMessage>
        )}
      </Container>
